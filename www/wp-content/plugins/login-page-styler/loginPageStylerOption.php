...
<div id="headings-data">
           <div id="hed3"><h3><?php _e('Security Settings') ?></h3></div>
           <table class="form-table">
        ...
        <tr valign='top'>
            ...
            <tr valign='top'>
                ...
                <td>
                    <div class="onoffswitch">
                     <input disabled type="checkbox" name="lps_reg_captcha" class="onoffswitch-checkbox"  id="myonoffswitchcap1" value='1'<?php checked(1, get_option('lps_reg_captcha')); ?> />
