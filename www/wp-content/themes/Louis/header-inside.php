...
<div id="hero">
	...
	<div class="postcontentmeta">
        <i class="fa fa-calendar"></i> <?php the_time( 'F j, Y' ) ?> <i class="fa fa-comment"></i> <?php comments_popup_link( __( 'Leave a comment', 'louis' ), __( '1 Comment', 'louis' ), __( '% Comments', 'louis' ) ); ?> <i class="fa fa-folder-open"></i> <?php the_category( ', ' ) ?></div>
        
<div class="herobuttons">
<?php the_tags( __( '', 'louis' ), ' ', '' ); ?>
</div>
