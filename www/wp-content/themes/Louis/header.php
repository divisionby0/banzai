...
if($sessions==''){ ?>
  <!-- -->
<div style="line-height: 28px; float: right; mergin-right: 30px;"><div class="auth_form">
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("louis-header") ) : ?>
<?php endif; ?>
</div></div>
<?
}
    ...
    <div id="site-branding">
        ...
        <a href="<?php echo esc_url( home_url() ); ?>" rel="home">
					...
					if ( $louis_display_header_logo === 'logo' ) {
						...
						echo '<img style="display: none;" src="' . esc_url( get_theme_mod( 'louis_header_logo_image' ) ) . '" />5555';
